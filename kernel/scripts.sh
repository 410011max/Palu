...
CUDA_VISIBLE_DEVICES=1 python abx_rope.py --total_rank 1024  --num_head_groups 1
CUDA_VISIBLE_DEVICES=1 python abx_rope.py --total_rank 1024  --num_head_groups 8
CUDA_VISIBLE_DEVICES=1 python abx_rope.py --total_rank 1024  --num_head_groups 16
CUDA_VISIBLE_DEVICES=1 python abx_rope.py --total_rank 1024  --num_head_groups 32
...
CUDA_VISIBLE_DEVICES=2 python abx_rope_share_head.py --total_rank 1024  --num_head_groups 8 
...
TRITON_PRINT_AUTOTUNING=1 CUDA_VISIBLE_DEVICES=1 python abx_rope.py --total_rank 1024 --num_head_groups 8
